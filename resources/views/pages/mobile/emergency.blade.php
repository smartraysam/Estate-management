    ...
    <div class="container ">
        <div class="section message-section">
            ...
            <div class="user-date row">
                ...
                <div class="col s12 " style="padding: 0; text-align: left;">
                    <p class="profile-1">Emergency Contacts</p>
                </div>
                        ...
                        <ul>
                            ...
                            <li class="no_sub">
                                ...
                                <ul class="list-unstyled">
                                        ...
                                        <div class="col s12 visit-status-card">
                                            ...
                                            <div class="row visit-status-card-inner">
                                                ...
                                                <div class="col s12 pad-0">
                                                    ...
                                                    <div class="blog-info">
                                                        <h6 class="title" style="text-transform:capitalize ; color: #000; margin: .5rem 0 1.2rem 0;">Neighbour 1</h6>
                                                ...
                                                <div class="col s12 pad-0">
                                                    <h6 class="title" style="text-transform:capitalize ; color: #000; margin: .5rem 0 .2rem 0; font-weight: 400;">081233455667</h6>
                                                </div>
                                        ...
                                        <div class="col s12 visit-status-card">
                                            ...
                                            <div class="row visit-status-card-inner">
                                                ...
                                                <div class="col s12 pad-0">
                                                    ...
                                                    <div class="blog-info">
                                                        <h6 class="title" style="text-transform:capitalize ; color: #000; margin: .5rem 0 1.2rem 0;">Gateman</h6>
                                        ...
                                        <div class="col s12 visit-status-card">
                                            ...
                                            <div class="row visit-status-card-inner">
                                                ...
                                                <div class="col s12 pad-0">
                                                    ...
                                                    <div class="blog-info">
                                                        <h6 class="title" style="text-transform:capitalize ; color: #000; margin: .5rem 0 1.2rem 0;">House Keeper</h6>
                                        ...
                                        <div class="col s12 visit-status-card">
                                            ...
                                            <div class="row visit-status-card-inner">
                                                ...
                                                <div class="col s12 pad-0">
                                                    ...
                                                    <div class="blog-info">
                                                        <h6 class="title" style="text-transform:capitalize ; color: #000; margin: .5rem 0 1.2rem 0;">Other Emergencies</h6>
                                    ...
                                    <a class="modal-trigger" href="#modalemergency" style="padding:0px ;">
                                    ...
                                    <div id="modalemergency" class="modal panic-modal" style="border-radius: 15px ;">
