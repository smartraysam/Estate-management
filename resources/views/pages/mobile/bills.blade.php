...
<head>
    ...
    <meta name="theme-color" content="#ffffff">
        ...
        <style>
            ...
            .panic-image i{
                position:relative;
                top: calc(45% - 10px); /* 50% - 3/4 of icon height */
            ...
            <ul class="collection mailbox z-depth-1">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li class="no_sub">
                            <a href=" {{ route('mobile.bills-payment') }} " class="waves-effect ">
                        
                                <h6> <i class="mdi mdi-lightbulb-on-outline" style="color: #131313;"></i> <span> Power </span> <span class="float-right"><i class="mdi mdi-chevron-right"></i></span>
                                </h6>
                            </a>
                    ...
                    <ul>
                        ...
                        <li class="no_sub">
                            <a href=" " class="waves-effect ">
                                <h6><i class="mdi mdi-cash-multiple"  style="color: #131313;"></i> <span> Service Fee </span> <span class="float-right"><i class="mdi mdi-chevron-right"></i></span>
                                </h6>
                            </a>
                    ...
                    <ul>
                        ...
                        <li class="no_sub">
                            <a href=" " class="waves-effect ">
                                <h6> <i class="mdi mdi-cash-multiple"  style="color: #131313;"></i>  <span> Others </span> <span class="float-right"><i class="mdi mdi-chevron-right"></i></span></h6>
                            </a>
